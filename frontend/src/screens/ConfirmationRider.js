...
// frontend/src/screens/ConfirmationRider.js
...
export default function ConfirmationRider({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      {/* circular emblem overlapping top-right of card */}
      <Image
...
const styles = StyleSheet.create({
  ...
  emblem: {
    position: "absolute",
    top: 90,
    right: WINDOW_W / 2 - 70, // visually similar to screenshot
    width: 120,
    height: 120,
  },
